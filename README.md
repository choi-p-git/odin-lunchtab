...
copyable evidence details. Actionable rows have a unique transfer row, a blank current
`OdinBalanceAmount`, and a suggested Odin balance. The viewer does not change the transfer
file. When generated by a reconciliation run, the report also
